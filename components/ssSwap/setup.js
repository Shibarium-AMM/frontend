...
function Setup() {
  ...
  const [ fromAssetValue, setFromAssetValue ] = useLocalStorage("SWAP_FROM_ASSET_VALUE", null)
  ...
  const [ toAssetValue, setToAssetValue ] = useLocalStorage("SWAP_TO_ASSET_VALUE", null)
...
function AssetSelect({ type, value, assetOptions, onSelect }) {
  ...
  return (
    <React.Fragment>
      ...
      <Dialog onClose={ onClose } aria-labelledby="simple-dialog-title" maxWidth="xs" fullWidth={true} open={ open } >
